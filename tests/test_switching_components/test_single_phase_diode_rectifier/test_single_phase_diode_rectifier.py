...
def test_single_phase_diode_rectifier(load_and_compile, VAC, f, iDC_expected):
    ...
    # Tests
    sig.assert_is_constant(iDC, during=(0.005005 - 0.0001, 0.005005 + 0.0001), at_value=around(iDC_expected, tol_p=0.01))
