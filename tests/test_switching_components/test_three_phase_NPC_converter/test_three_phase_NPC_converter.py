...
def test_three_phase_NPC_converter(load_and_compile, VDC1,VDC2, iA_expected, iB_expected,iC_expected):
    ...
    # Tests
    sig.assert_is_constant(iA, during=(0.03 - 0.001, 0.03 + 0.001), at_value=around(iA_expected, tol_p=0.01))

    sig.assert_is_constant(iB, during=(0.03 - 0.001, 0.03 + 0.001), at_value=around(iB_expected, tol_p=0.01))
